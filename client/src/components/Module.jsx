      ...
      <React.Fragment>
        ...
        <div className="container">
          <div className="mx-md-5">
            ...
            <div className="m-5">
              <Link
                to={this.props.moduleName + "/quiz/1"}
        ...
        body: (
          <React.Fragment>
            ...
            <p>
              ...
              neither take information from others without attribution or by
              unfair means, nor do you supply course information to others. The
              University of Winnipeg treats cases of plagiarism, cheating,
              unwarranted collaboration, and other forms of academic dishonesty
              very seriously. Honesty and fairness are integral parts of the
              University's mission. Any member of the University community who
              violates these principles is dealt with as if he/she is damaging
              the reputation and accomplishments of the University itself.
            </p>
            <p>
              The standards regulating research conduct that the University of
            ...
            <p>
              The Calendar outlines various forms of misconduct as well as the
              steps that unfold when misconduct is said to have occurred and
              cases are adjudicated.
            </p>
            <p>
              To avoid misconduct situations, you are encouraged to read
              <a href="http://library.uwinnipeg.ca/help-with-research/index.html">
                useful Library pages
              </a>
              online that set out research and documentation procedures and
              resources:
            </p>
            <p>
              You also have rights as a student. The University of Winnipeg
              Student Association (UWSA) has prepared a document that not only
              describes misconduct events to avoid but also the steps you can
              take to find support if you are charged with a misconduct
              incident.
            </p>
            <p>
              In this introductory module, you will be presented with terms,
              definitions, proper practices, and links to sites where you can
              find more information and examples.
            </p>
            <p>
              In module two, you will learn more about the specific form of
              misconduct called <strong>plagiarism</strong>. This involves
              taking words and ideas of another and presenting them without
              attribution as if they were your own. This is misleading to
              readers. It also fails to give credit to the scholar who developed
              the content and to the source where the information appeared. On
              the other hand, when you document your sources correctly, you
              provide prospective readers with a link to topical material.
            </p>
            <p>
              To avoid plagiarism, you need to follow the guidelines of a
              research manual and system.
            </p>
            <p>
              Module three deals with avoiding <strong>cheating</strong> in test
              and exam situations. It also presents a view of unfair, and often
